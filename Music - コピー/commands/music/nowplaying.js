...
module.exports = {
    ...
    execute(client, message) {
        ...
        const trackDuration = timestamp.progress == 'Infinity' ? 'ライブ配信' : track.duration;

        embed.setDescription(`音量 **${queue.volume}**%\n継続時間 **${trackDuration}**\nループモード **${methods[queue.repeatMode]}**\nコマンド使用者 ${track.requestedBy}`);
